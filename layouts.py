    ...
    [
        sg.Frame('', [
                ...
                [
                    ...
                    sg.ProgressBar(visible=False, max_value=100, orientation='horizontal', style='classic', key='-LINK_PROGRESSBAR-', size=(1, 60), expand_x=True,)
                ]
            ], 
...
SEARCH_TAB_LAYOUT = [
        ...
        sg.Frame('', [
                ...
                [
                    sg.ProgressBar(visible=False, max_value=100, orientation='horizontal', style='classic', key='-SEARCH_PROGRESSBAR-', size=(1, 60), expand_x=True)
                ]
            ], 
            size=(WIDTH, HEIGTH/100*90)
            )
